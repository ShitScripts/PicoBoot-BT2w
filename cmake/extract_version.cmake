...
#
# Relaxed: git is optional on the build host. If it is not found, or describe
# fails, a fallback version string is used.
...
if(GIT_EXECUTABLE)
    ...
    message(WARNING "git not found. Using default version string.")
